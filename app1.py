# -*- coding: utf-8 -*-
"""
实验组整合应用 - 真实反馈版 (Real Feedback)# -*- coding: utf-8 -*-
"""
...
def experiment():
    ...
    if phase == 'pre_survey' or phase == 'post_survey':
        ...
        user_group = session_data.get('user_group', 'treatment') 
        
        template_name = 'questionnaire_treatment.html'
        is_control = False
        
        if user_group == 'control':
            template_name = 'questionnaire_control.html'
            is_control = True
